...
function mostrarDatosPedido(){
	...
	// Función para llenar los minutos según la hora seleccionada
	function actualizarMinutos() {
		const horaSelec = parseInt(horaSeleccionada.value);
		minutoSeleccionado.innerHTML = ''; // limpia opciones anteriores
		...
		// Si es la hora actual, deshabilita minutos menores al actual
...
// <a href="index.php?action=verPedido" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Finalizar pedido</a>