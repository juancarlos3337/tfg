...
//Funcion para iniciar sesion en la aplicacion web.
    function iniciarSesion(){
        ...
        if($usuario->comprobarUsuario($_POST["nombre"],$_POST["pw"],$_POST["email"])){ //comprobamos con la bd que existe el usu y la contraseña
            ...
            // una vez comprobamos que existe el usuario, nos guardamos el tipo de usuario y lo mandamos a la pagina principal pero con la sesion iniciada
           header("Location: ../controlador/index.php");
            exit;

        }else{
           
          $_SESSION['errorIniciar']= "Nombre , Email o Contraseña incorrectos";
    ...
    function verCarta(){
        // antes de cambiar de vista obtenemos todas las papas de la bd para luego mostrarla en la vista
        require_once("../modelo/class.patatas.php");           
        $patata=new patata();
        $patatas=$patata->listarPatatas();
        $contador=count($patatas);//obtenemos la longitud del array para usarlo con posterioridad
    ...
    function realizarPedido(){
        ...
        //opcion1
        //antes de redirigir tengo que eliminar el carro. imprimo un script para eliminar el carrito
        //tengo que redireccionar desde js porque si uso el header location no imprime el script
        // echo "
        //     <script>
        ...
        //opcion 2
        //redirijo a una vista que me diga que el pedido se realiza con exito
    ...
    // nada mas empezar, redijiremos a la pagina principal, si no esta seteada la sesion significa que no ha iniciadop sesion, si inicia sedsion, se guarda el nombre de usaurio
